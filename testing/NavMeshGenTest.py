...
# rogue_pixel_threshold = 5000
# num_labels, labels, stats, centroids = cv2.connectedComponentsWithStats(inverted_red_mask, connectivity=8)
# for i in range(1, num_labels):
#     if stats[i, cv2.CC_STAT_AREA] < rogue_pixel_threshold:
#         inverted_red_mask[labels == i] = 255
