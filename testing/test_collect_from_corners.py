...
from src.client.field.collect_from_corner import get_corner_with_displacement, check_corners, ball_is_in_corner
...
if ball_is_in_corner(ball_coords_1):
    ...
    pivot_points, corner_points = get_corner_with_displacement(corner_result)
...
if ball_is_in_corner(ball_coords_2):
    ...
    pivot_points, corner_points = get_corner_with_displacement(corner_result_2)
