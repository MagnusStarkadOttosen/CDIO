...
from src.client.field.collect_from_corner import ball_is_in_corner, check_corners, get_pivot
...
from src.client.vision.shape_detection import detect_obstacles, detect_robot, safe_detect_balls, safe_detect_robot
