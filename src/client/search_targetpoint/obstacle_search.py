...
def obstacle_Search(ball_dot, midpoint):
    ...
    if ball_dot[0] < midpoint[0] and ball_dot[1] < midpoint[1]:
        ...
        target= (midpoint[0] - 85, midpoint[1] + 200)
...
def is_ball_in_obstacle(ball_dot, midpoint):
    ...
    if(abs(ball_dot[0]-midpoint[0])<100 and abs(ball_dot[1]-midpoint[1])<100):
        target_point,target = obstacle_Search(ball_dot, midpoint)
        print(f"target_point: {target_point} target:{target}bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb")
